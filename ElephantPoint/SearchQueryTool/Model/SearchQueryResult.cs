...
namespace SearchQueryTool.Model
{
    public class ResultItem : SortedDictionary<string, string>
    {
        ...
        public string createdDateTime
        {
            get
            {
                return this.FirstOrDefault(x => x.Key.Equals("createdDateTime", StringComparison.InvariantCultureIgnoreCase)).Value;
            }
        }
        ...
        public string LastModifiedTime
        {
            get
            {
                return this.FirstOrDefault(x => x.Key.Equals("LastModifiedTime", StringComparison.InvariantCultureIgnoreCase)).Value;
            }
        }
        ...
        public string Size
        {
            get
            {
                return this.FirstOrDefault(x => x.Key.Equals("Size", StringComparison.InvariantCultureIgnoreCase)).Value;
            }
        }
        ...
        public string Author
        {
            get
            {
                return this.FirstOrDefault(x => x.Key.Equals("Author", StringComparison.InvariantCultureIgnoreCase)).Value;
            }
        }
